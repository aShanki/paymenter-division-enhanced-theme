    ...
    <div class="flex flex-col gap-6 col-span-3">
        ...
        <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-4 h-fit">
            @foreach ($products as $product)
                <div class="flex bg-background-secondary hover:bg-background-secondary/80 border border-neutral p-4 rounded-xl shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105 gap-4">
                    ...
                    <div class="flex flex-col justify-start text-left flex-grow">
                        ...
                        @if($product->description)
                            <div class="mt-2 max-h-32 overflow-y-auto">
                                <article class="prose dark:prose-invert prose-sm max-w-none leading-relaxed text-left">
                                    {!! $product->description !!}
                                </article>
                            </div>
                        @endif
